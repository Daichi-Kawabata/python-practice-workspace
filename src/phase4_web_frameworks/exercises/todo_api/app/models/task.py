...
class Task(Base):
    ...
    priority: MappedColumn[str] = mapped_column(String, default="medium")  # low, medium, high
    ...
    created_at: MappedColumn[datetime] = mapped_column(DateTime, default=datetime.utcnow)
    updated_at: MappedColumn[datetime] = mapped_column(DateTime, default=datetime.utcnow, onupdate=datetime.utcnow)
